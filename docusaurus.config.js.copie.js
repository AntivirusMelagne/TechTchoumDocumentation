...
const config = {
  ...
  organizationName: 'https://github.com/AntivirusMelagne/', // 👉 remplace par ton compte GitHub
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/ton-utilisateur-github/nextjs-docs/tree/main/',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/ton-utilisateur-github/nextjs-docs',
          label: 'GitHub',
          position: 'right',
        },
      ],
